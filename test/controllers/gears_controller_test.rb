...
class GearsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gear" do
    assert_difference('Gear.count') do
      post gears_url, params: { gear: { gearname: @gear.gearname, picture: @gear.picture, price: @gear.price } }
    end
  ...
  test "should update gear" do
    patch gear_url(@gear), params: { gear: { gearname: @gear.gearname, picture: @gear.picture, price: @gear.price } }
